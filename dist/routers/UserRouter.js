...
class UserRouter {
    ...
    postRoutes() {
        ...
        this.router.post('/refresh_token', GlobalMiddleWare_1.GlobalMiddleWare.decodeRefreshToken, GlobalMiddleWare_1.GlobalMiddleWare.checkError, UserController_1.UserController.getNewTokens);
    ...
    putRoutes() {
        this.router.put('/updateprofilePic', GlobalMiddleWare_1.GlobalMiddleWare.auth, new utils_1.Utils().multer.single('profileImages'), UserValidators_1.UserValidators.userProfilePic(), GlobalMiddleWare_1.GlobalMiddleWare.checkError, UserController_1.UserController.updateUserProfilePic);
    }
    deleteRoutes() { }
}
